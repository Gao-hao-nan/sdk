...
import com.ghn.mylibrary.data.BaseMultipleChoiceBean
import com.ghn.mylibrary.data.BaseNoDragBean
 ...
 * @Description: TODO 普通适配器,适配器之父
 */
abstract class BaseAdapter<T> (@LayoutRes private val layoutId: Int = 0) : RecyclerView.Adapter<BaseViewHolder>() {
